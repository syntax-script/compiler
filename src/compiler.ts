    ...
    public compileSyx(file: string) {
        ...
        ast.body.forEach(statement => {
            ...
            if (statementIsA(statement, NodeType.Operator)) {
                ...
                const operatorStmtExport: ExportedOperator = { imports: {}, outputGenerators: {}, regexMatcher, type: ExportType.Operator, source: file, handle: statement };
                ...
                const statementExport: ExportedFunction = { type: ExportType.Function, args: statement.arguments.map(s => regexes[s.value]), name: statement.name.value, formatNames: {}, imports: {}, source: file, handle: statement };
                ...
                out.push({ type: ExportType.Keyword, word: statement.word.value, source: file, handle: statement });
